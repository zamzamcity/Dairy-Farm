    ...
    <form action="<?= base_url('feeding-consumption/feedingConsumption/edit/' . $feed['id']) ?>" method="post">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <?php if (isSuperAdmin()): ?>
            <div class="form-group">
              <label for="tenant_id<?= $feed['id'] ?>">Tenant</label>
              <select name="tenant_id" id="tenant_id<?= $feed['id'] ?>" class="form-control">
                <option value="">Select Tenant</option>
                <?php foreach ($tenants as $tenant): ?>
                  <option value="<?= $tenant['id'] ?>" <?= $feed['tenant_id'] == $tenant['id'] ? 'selected' : '' ?>>
                    <?= esc($tenant['name']) ?>
                  </option>
                <?php endforeach; ?>
              </select>
...
<div class="container-fluid">
  ...
  <div class="mb-3 text-right">
    <a href="<?= base_url('feeding-consumption/feedingConsumption/export')
  ...
  <div class="card shadow mb-4">
    ...
    <div class="table-responsive">
      ...
      <?php if (empty($feeding_consumptions)): ?>
        <tr>
          <td colspan="6" class="text-center">No feeding consumption records found.</td>
        </tr>
      <?php endif; ?>
      <?php if (!empty($feeding_consumptions)): ?>
        <tr>
