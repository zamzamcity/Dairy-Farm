...
<head>
    ...
    <meta name="description" content="Feeding_Consumption UI Page">
    <meta name="author" content="">

    <title>SB Admin 2 - Feeding_Consumption</title>
...
<li class="nav-item active">
    <a class="nav-link" href="#" data-toggle="collapse" data-target="#collapseFeedingConsumption"
    aria-expanded="true" aria-controls="collapseFeedingConsumption">
    <i class="fas fa-fw fa-utensils"></i>
    <span>Feeding Consumption</span>
</a>
<div id="collapseFeedingConsumption" class="collapse show" aria-labelledby="headingFeedingConsumption" data-parent="#accordionSidebar">
    <div class="bg-white py-2 collapse-inner rounded">
        <h6 class="collapse-header">Manage Feed Consumption:</h6>
        <a class="collapse-item active" href="<?= base_url('feeding-consumption/feedingConsumption') ?>">Feeding Consumption</a>
    </div>
</div>
</li>
<?php endif; ?>
...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Feeding Consumption</h1>
    </div>
    ...
    <?php if (hasPermission('CanAddFeedingConsumption')): ?>
    <div class="mb-3 text-right">
        <a href="#" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addFeedingConsumptionModal">+ Add Feeding Consumption</a>
    </div>
    <?php endif; ?>
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <?php foreach ($feeding_consumptions as $consumption): ?>
                        <tr>
                            ...
                            <?php if (hasPermission('CanUpdateFeedingConsumption') || hasPermission('CanDeleteFeedingConsumption')): ?>
                            <td>
                                <?php if (hasPermission('CanUpdateFeedingConsumption')): ?>
                                <a href="#" class="btn btn-sm btn-info" data-toggle="modal" data-target="#editFeedingConsumptionModal<?= $consumption['id'] ?>">Edit</a>
                                <?php endif; ?>
                                <?php if (hasPermission('CanDeleteFeedingConsumption')): ?>
                                <a href="#" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#deleteFeedingConsumptionModal<?= $consumption['id'] ?>">Delete</a>
                                <?php endif; ?>
                            </td>
                            <?php endif; ?>
                        </tr>
                        ...
                        <tr>
                            <td colspan="5" class="text-center">No feeding consumption records found.</td>
                        </tr>
                        <?php endif; ?>
                        <?php if (!empty($feeding_consumptions)): ?>
                        <tr>
