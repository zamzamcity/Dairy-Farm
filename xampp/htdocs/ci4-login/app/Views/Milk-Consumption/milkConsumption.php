...
<li class="nav-item">
    <a class="nav-link collapsed" href="<?= base_url('dailyMilk') ?>">
        <i class="fas fa-fw fa-tachometer-alt"></i>
    ...
    <li class="nav-item active">
        <a class="nav-link" href="#" data-toggle="collapse" data-target="#collapseMilkConsumption"
        aria-expanded="true" aria-controls="collapseMilkConsumption">
        <i class="fas fa-fw fa-filter"></i>
        <span>Milk Consumption</span>
    </a>
    <div id="collapseMilkConsumption" class="collapse show" aria-labelledby="headingMilkConsumption" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Manage Milk Consumption:</h6>
            <a class="collapse-item active" href="<?= base_url('milk-consumption/milkConsumption') ?>">Milk Consumption</a>
...
<div class="container-fluid">
    ...
    <form method="get" class="form-inline mb-3">
        ...
        <input type="date" id="date" name="date" value="<?= esc($selected_date) ?>" class="form-control mr-2" required>
