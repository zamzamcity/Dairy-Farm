...
<head>
    ...
    <meta name="description" content="Stock_Ledger UI Page">
    <meta name="author" content="">

    <title>SB Admin 2 - Stock_Ledger</title>
...
<div class="container-fluid">
    ...
    <div class="mb-3 text-right">
        <a href="<?= site_url('stock/exportStockLedger?from_date=' . $fromDate . '&to_date=' . $toDate . '&head_id=' . $selectedHead) ?>" class="btn btn-primary mb-3">
            Download Excel
        </a>
    </div>
