...
<div class="modal fade" id="editAnimalMilkModal<?= $entry['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="editAnimalMilkModalLabel<?= $entry['id'] ?>" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <div class="form-group">
        ...
        <input type="number" step="0.01" class="form-control" name="milk_1" value="<?= esc($entry['milk_1']) ?>">
    </div>
...
<li class="nav-item active">
    <a class="nav-link" href="#" data-toggle="collapse" data-target="#collapseAnimalMilking"
    aria-expanded="true" aria-controls="collapseAnimalMilking">
    <i class="fas fa-fw fa-glass-whiskey"></i>
    <span>Animal Milking</span>
</a>
<div id="collapseAnimalMilking" class="collapse show" aria-labelledby="headingAnimalMilking" data-parent="#accordionSidebar">
    <div class="bg-white py-2 collapse-inner rounded">
        <h6 class="collapse-header">Animal Milk Management:</h6>
        <a class="collapse-item active" href="<?= base_url('animal-milking/animalMilk') ?>">Manage Animal Milk</a>
    </div>
</div>
</li>
<?php endif; ?>
