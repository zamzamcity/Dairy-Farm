...
<li class="nav-item active">
    <a class="nav-link" href="#" data-toggle="collapse" data-target="#collapsePen"
    aria-expanded="true" aria-controls="collapsePen">
    <i class="fas fa-fw fa-warehouse"></i>
    <span>Pen/Semen/Tech</span>
</a>
<div id="collapsePen" class="collapse show" aria-labelledby="headingPen" data-parent="#accordionSidebar">
    <div class="bg-white py-2 collapse-inner rounded">
        <h6 class="collapse-header">Management:</h6>
        <?php if (hasPermission('CanViewPen')): ?>
            <a class="collapse-item active" href="<?= base_url('pen-semen-tech/pen') ?>">Pen</a>
        <?php endif; ?>
...
<?php if (hasPermission('CanViewStockLedger')): ?>
    ...
    <?php endif; ?><?php if (hasPermission('CanViewChartOfAccounts')): ?>
<!-- Divider -->
<hr class="sidebar-divider d-none d-md-block">
<!-- Heading -->
<div class="sidebar-heading">
