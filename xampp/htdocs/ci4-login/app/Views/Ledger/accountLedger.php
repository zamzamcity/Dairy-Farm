...
<li class="nav-item active">
    <a class="nav-link" href="#" data-toggle="collapse" data-target="#collapseLedger"
    aria-expanded="true" aria-controls="collapseLedger">
    <i class="fas fa-fw fa-clipboard-list"></i>
    <span>Ledger</span>
</a>
<div id="collapseLedger" class="collapse show" aria-labelledby="headingLedger" data-parent="#accordionSidebar">
    <div class="bg-white py-2 collapse-inner rounded">
        <h6 class="collapse-header">Manage Ledger:</h6>
        <a class="collapse-item active" href="<?= base_url('ledger/accountLedger') ?>">Account Ledger</a>
    </div>
</div>
</li>
<?php endif; ?>
