...
<?php if (hasPermission('CanViewPages')): ?>
    ...
    <div class="bg-white py-2 collapse-inner rounded">
        ...
        <a class="collapse-item active" href="<?= base_url('pages/blank') ?>">Blank Page</a>
    </div>
</div>
</li>
<?php endif; ?>
...
<a class="dropdown-item d-flex align-items-center" href="#">
    <div class="dropdown-list-image mr-3">
        <img class="rounded-circle" src="<?= base_url('assets/sb-admin-2/img/undraw_profile_1.svg') ?>"
        alt="...">
...
<a class="dropdown-item d-flex align-items-center" href="#">
    <div class="dropdown-list-image mr-3">
        <img class="rounded-circle" src="<?= base_url('assets/sb-admin-2/img/undraw_profile_2.svg') ?>"
        alt="...">
...
<a class="dropdown-item d-flex align-items-center" href="#">
    <div class="dropdown-list-image mr-3">
        <img class="rounded-circle" src="<?= base_url('assets/sb-admin-2/img/undraw_profile_3.svg') ?>"
        alt="...">
