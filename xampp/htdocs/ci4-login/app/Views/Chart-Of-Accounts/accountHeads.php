...
<li class="nav-item active">
    <a class="nav-link" href="#" data-toggle="collapse" data-target="#collapseChartOfAccounts"
    aria-expanded="true" aria-controls="collapseChartOfAccounts">
    <i class="fas fa-fw fa-file-alt"></i>
    <span>Chart of Accounts</span>
</a>
<div id="collapseChartOfAccounts" class="collapse show" aria-labelledby="headingChartOfAccounts" data-parent="#accordionSidebar">
    <div class="bg-white py-2 collapse-inner rounded">
        <h6 class="collapse-header">Manage Accounts:</h6>
        <a class="collapse-item active" href="<?= base_url('chart-of-accounts/accountHeads') ?>">Account Heads</a>
    </div>
</div>
</li>
<?php endif; ?>
