...
<li class="nav-item active">
    <a class="nav-link" href="#" data-toggle="collapse" data-target="#collapseMedicineConsumption"
...
<div id="collapseMedicineConsumption" class="collapse show" aria-labelledby="headingMedicineConsumption" data-parent="#accordionSidebar">
    <div class="bg-white py-2 collapse-inner rounded">
        <h6 class="collapse-header">Manage Medicine Consump:</h6>
        <a class="collapse-item active" href="<?= base_url('medicine-consumption/medicineConsumption') ?>">Medicine Consumption</a>
    </div>
</div>
</li>
<?php endif; ?>
