...
<div class="modal fade" id="editJournalVoucherModal<?= $voucher['id'] ?>" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-xl" role="document">
        <form action="<?= base_url('vouchers/journalVoucher/edit/' . $voucher['id']) ?>" method="post">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Edit Journal Voucher</h5>
...
<!-- Delete Journal Voucher Modal -->
<div class="modal fade" id="deleteJournalVoucherModal<?= $voucher['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="deleteJournalVoucherModalLabel<?= $voucher['id'] ?>" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form action="<?= base_url('vouchers/journalVoucher/delete/' . $voucher['id']) ?>" method="post">
            <div class="modal-content">
                <div class="modal-header">
...
<div id="collapseVouchers" class="collapse show" aria-labelledby="headingVouchers" data-parent="#accordionSidebar">
    <div class="bg-white py-2 collapse-inner rounded">
        ...
        <a class="collapse-item active" href="<?= base_url('vouchers/journalVoucher') ?>">Journal Voucher</a>
    </div>
</div>
</li>
<?php endif; ?>
...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Journal Vouchers</h1>
    </div>

    <?php if (hasPermission('CanAddJournalVoucher')): ?>
    <div class="mb-3 text-right">
        <a href="#" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addJournalVoucherModal">+ Add Journal Voucher</a>
    </div>
    <?php endif; ?>
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-bordered" id="jVoucherTable">
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <th>Description</th>
                            <th>Total Amount</th>
                            <?php if (hasPermission('CanUpdateJournalVoucher') || hasPermission('CanDeleteJournalVoucher')): ?>
                            <th>Actions</th>
                            <?php endif; ?>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <?php if (hasPermission('CanUpdateJournalVoucher') || hasPermission('CanDeleteJournalVoucher')): ?>
                            <td>
                                <?php if (hasPermission('CanUpdateJournalVoucher')): ?>
                                <a href="#" class="btn btn-sm btn-info" data-toggle="modal" data-target="#editJournalVoucherModal<?= $voucher['id'] ?>">Edit</a>
                                <?php endif; ?>
                                <?php if (hasPermission('CanDeleteJournalVoucher')): ?>
                                <a href="#" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#deleteJournalVoucherModal<?= $voucher['id'] ?>">Delete</a>
                                <?php endif; ?>
                            </td>
                            <?php endif; ?>
                        </tr>
...
<div class="modal fade" id="addJournalVoucherModal" tabindex="-1" role="dialog" aria-labelledby="addJournalVoucherModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <form action="<?= base_url('vouchers/journalVoucher/add') ?>" method="post">
            <div class="modal-content">
                <div class="modal-header">
