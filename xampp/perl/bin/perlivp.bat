...
#!perl
#line 29
    eval 'exec C:\Users\zamza\Documents\GitHub\Dairy-Farm\xampp\perl\bin\perl.exe -S $0 ${1+"$@"}'
...
my $perlpath = 'C:\Users\zamza\Documents\GitHub\Dairy-Farm\xampp\perl\bin\perl.exe';
